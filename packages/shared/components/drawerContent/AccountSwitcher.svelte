<script lang="typescript">
    ...
    import { isSyncing, isTransferring, selectedAccountStore, setSelectedAccount } from '@lib/wallet'
...
<div class="accounts flex flex-col space-y-1 overflow-auto mb-5">
    {#each accounts as account}
        ...
        >
            ...
            <Text classes={account.id !== $selectedAccountStore?.id ? 'opacity-50' : ''} type="h5">{account.alias}</Text
            >
        </button>
    {/each}
</div>
