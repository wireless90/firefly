<script lang="ts">
    ...
    import MintNftCollectionConfirmationPopup from './MintNftCollectionConfirmationPopup.svelte'
    import MintNftCollectionFormPopup from './MintNftCollectionFormPopup.svelte'
